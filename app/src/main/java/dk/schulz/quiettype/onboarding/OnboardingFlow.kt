        ...
        fun default(): OnboardingFlow = OnboardingFlow(
            steps = listOf(
                OnboardingStep(
                    ...
                    body = "QuietType will appear only when you need it, next to your normal keyboard, so typing still works as usual.",
                ...
                OnboardingStep(
                    ...
                    body = "QuietType is designed for offline speech recognition, no telemetry, and no transcript history by default.",
                ),
                OnboardingStep(
                    id = OnboardingStepId.InteractionMode,
                    eyebrow = "Step 3 of 5",
                    title = "Enable the floating mic button.",
                    body = "QuietType uses Android Accessibility to notice focused editable fields and place a draggable mic button beside the keyboard. This permission must be enabled manually in Android settings.",
                ...
                OnboardingStep(
                    ...
                    body = "QuietType asks for microphone access only when you explicitly tap this step. Audio capture is local and starts later only while you hold or toggle the floating dictation button.",
                ...
                OnboardingStep(
                    ...
                    body = "QuietType defaults to a compact multilingual model candidate. Open Models to review language coverage, size, license notes, and checksum before downloading.",
