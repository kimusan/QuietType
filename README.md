...
- Correction-model downloads are also explicit and local-only; current Fix downloads can be managed on the Models screen, while built-in cleanup remains the active runtime fallback until on-device LLM correction is integrated.
